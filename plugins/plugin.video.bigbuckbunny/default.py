...
def INDEX():
        ...
        addDir('4K, Quad-Full-HD (3840x2160)','url',7,thumb,'',fanart)
        addDir('Full HD (1920x1080)','url',1,thumb,'',fanart)
        addDir('720p HD (1280x720)','url',2,thumb,'',fanart)
        addDir('480p HD (854x480)','url',3,thumb,'',fanart)
